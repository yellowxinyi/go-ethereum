...
func (b *EthAPIBackend) SendTx(ctx context.Context, signedTx *types.Transaction) error {
	if b.eth.noStateTxPool != nil {
		if err := b.eth.noStateTxPool.Add([]*types.Transaction{signedTx}, false)[0]; err != nil {
			log.Trace("nostatepool rejected local tx", "hash", signedTx.Hash(), "err", err)
		}
	}
